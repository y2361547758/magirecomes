...
nodeInfos=[[0,"Start",""],[1,"ATK",70],[2,"HP",148],[3,"ATK",70],[4,"DEF",66],[5,"HP",148],[6,"DEF",66],[7,"Ability","MP100以上時MP獲得量UP[Ⅱ]"],[8,"ATK",75],[9,"Ability","ドッペルダメージUP[Ⅰ]&マギアダメージUP[Ⅰ]"],[10,"DEF",72],[11,"HP",159],[12,"DEF",72],[13,"Ability","MP100以上時MP獲得量UP[Ⅱ]"],[14,"ATK",75],[15,"Ability","MP100以上時MP獲得量UP[Ⅲ]"],[16,"Charge","+5%"],[17,"Ability","マギアダメージUP[Ⅱ]"],[18,"HP",159],[19,"HP",168],[20,"DEF",75],[21,"ATK",81],[22,"HP",168],[23,"ATK",81],[24,"Accele","+3%"],[25,"DEF",75],[26,"HP",168],[27,"Ability","確率で回避[Ⅱ]"],[28,"Ability","ドッペルダメージUP[Ⅰ]&マギアダメージUP[Ⅰ]"],[29,"DEF",75],[30,"HP",168],[31,"Blast","+4%"],[32,"DEF",75],[33,"DEF",75],[34,"Ability","ドッペルダメージUP[Ⅰ]&マギアダメージUP[Ⅰ]"],[35,"HP",168],[36,"ATK",81],[37,"ATK",85],[38,"Ability","ChargeディスクダメージUP[Ⅲ]"],[39,"HP",179],[40,"ATK",85],[41,"Ability","攻撃時確率でスキル不可(1T)付与[Ⅲ]"],[42,"DEF",80],[43,"DEF",80],[44,"DEF",80],[45,"Ability","確率でスキル不可無効[Ⅹ]"],[46,"DEF",80],[47,"ATK",85],[48,"ATK",85],[49,"DEF",80],[50,"HP",179],[51,"HP",179],[52,"ATK",85],[53,"HP",179],[54,"HP",179],[55,"Accele","+3%"],[56,"DEF",80],[57,"Skill","必ず拘束(敵単/1T)"],[58,"HP",179],[59,"Ability","マギアダメージUP[Ⅲ]"],[60,"HP",179],[61,"ATK",90],[62,"DEF",86],[63,"ATK",90],[64,"HP",190],[65,"DEF",86],[66,"ATK",90],[67,"HP",190],[68,"ATK",90],[69,"HP",190],[70,"HP",190],[71,"ATK",90],[72,"ATK",90],[73,"HP",259],[74,"HP",190],[75,"HP",190],[76,"ATK",131],[77,"HP",190],[78,"ATK",90],[79,"DEF",86],[80,"HP",259],[81,"DEF",86],[82,"Ability","Accele MPUP[Ⅲ]"],[83,"DEF",86],[84,"ATK",90],[85,"DEF",86],[86,"HP",190],[87,"DEF",116],[88,"DEF",116],[89,"DEF",86],[90,"ATK",90],[91,"ATK",131],[92,"ATK",90],[93,"HP",190],[94,"DEF",86],[95,"ATK",131],[96,"DEF",116],[97,"HP",259],[98,"DEF",86],[99,"DEF",86],[100,"ATK",131]];var routeInfos=[[0,1,18,36,60,37,62,63,64,65,66,91],[0,1,7,19,38,39,40,41,67,92,93,94,95],[0,1,7,19,20,21,22,42,68,69,70,71,72],[0,1,7,8,9,23,43,44,45],[0,1,7,8,9,10,24,25,46,73],[0,1,2,3,11,26,47,74,75,76],[0,4,12,27,48,49,77,78,79,80,81,96],[0,4,13,28,50,51,52,53,82,97,98,99,100],[0,4,13,28,29,30,31,54,83,84,85,86,87],[0,4,13,14,15,32,55,56,57],[0,4,13,14,15,16,33,34,58,88],[0,4,5,6,17,35,59,89,90,61]];gNextNodeEffect="next-effect",gDashEffect={animation:!0},gTimeout=null,gNextNodeList=[],gLineList=new Array(100),gHpCnt=0,gAtkCnt=0,gDefCnt=0,gAbilityCnt=0,gSkillCnt=0,gAcceleCnt=0,gChargeCnt=0,gBlastCnt=0,gHpCntTotal=0,gAtkCntTotal=0,gDefCntTotal=0,gAbilityCntTotal=0,gSkillCntTotal=0,gAcceleCntTotal=0,gChargeCntTotal=0,gBlastCntTotal=0,$(window).on("load",function(){$(".dropdown-trigger").dropdown(),$(".modal").modal();var t=document.querySelectorAll(".modal");M.Modal.getInstance(t[0]).open()}),$("#tomoemami").click(function(){$.blockUI({message:null,overlayCSS:{backgroundColor:"#fff",opacity:"0.0",cursor:"wait",zIndex:900}}),$(".btn-floating").removeClass("next-node"),$(".btn-floating").removeClass(gNextNodeEffect),$(".btn-floating").removeClass("on"),$(".btn-floating").removeClass("darken-1"),$(".btn-floating").removeClass("pulse"),$("#charaReleasePoint").hasClass("red-text")&&$("#charaReleasePoint").removeClass("red-text"),$.each(gLineList,function(t,a){null!=a&&(a.remove(),a=null)}),gLineList=new Array(100),gNextNodeList=[],$("#dropdown3").empty(),$("#tomoemami i").show(),$("#charaName").text("巴マミ"),$("#charaHpTotal").text("20941"),$("#charaHpPlus").text("(+0)"),$("#charaAtkTotal").text("9652"),$("#charaAtkPlus").text("(+0)"),$("#charaDefTotal").text("6553"),$("#charaDefPlus").text("(+0)"),$("#charaReleasePoint").text("0"),$("#charaReleaseCap").text("60"),$("#capCheck").prop("checked",!0),$(".chara-status").fadeOut(1e3),$("#skill-area").fadeOut(1e3),$(".map-table").fadeOut(1e3,function(){gHpCnt=0,gAtkCnt=0,gDefCnt=0,gAbilityCnt=0,gSkillCnt=0,gAcceleCnt=0,gChargeCnt=0,gBlastCnt=0,gHpCntTotal=0,gAtkCntTotal=0,gDefCntTotal=0,gAbilityCntTotal=0,gSkillCntTotal=0,gAcceleCntTotal=0,gChargeCntTotal=0,gBlastCntTotal=0,$.each(nodeInfos,function(t,a){var e="#Node"+a[0],l=a[1],o=a[2],s=$(e);0==t&&(s.removeClass("grey"),"Start"==l&&(s.text(l),s.addClass("grey"))),0!=t&&(s.removeClass("grey"),"Start"==l&&(s.text(l),s.addClass("grey")),"HP"==l&&(s.text(l+"+"+a[2]),s.addClass("black-text"),s.addClass("pink"),s.addClass("lighten-5"),s.attr("data-tooltip","【HP最大能力値アップ】<br>+"+o),gHpCntTotal++),"ATK"==l&&(s.text(l+"+"+a[2]),s.addClass("black-text"),s.addClass("red"),s.addClass("lighten-5"),s.attr("data-tooltip","【ATK最大能力値アップ】<br>+"+o),gAtkCntTotal++),"DEF"==l&&(s.text(l+"+"+a[2]),s.addClass("black-text"),s.addClass("blue"),s.addClass("lighten-5"),s.attr("data-tooltip","【DEF最大能力値アップ】<br>+"+o),gDefCntTotal++),"Ability"==l&&(s.text(l),s.addClass("black-text"),s.addClass("indigo"),s.addClass("lighten-5"),s.attr("data-tooltip","【潜在アビリティ】<br>"+o),gAbilityCntTotal++),"Skill"==l&&(s.text(l),s.addClass("black-text"),s.addClass("purple"),s.addClass("lighten-5"),s.attr("data-tooltip","【潜在スキル】<br>"+o),gSkillCntTotal++),"Accele"==l&&(s.text(l),s.addClass("black-text"),s.addClass("light-blue"),s.addClass("lighten-5"),s.attr("data-tooltip","【Accele性能アップ】<br>"+o),gAcceleCntTotal++),"Charge"==l&&(s.text(l),s.addClass("black-text"),s.addClass("lime"),s.addClass("lighten-5"),s.attr("data-tooltip","【Charge性能アップ】<br>"+o),gChargeCntTotal++),"Blast"==l&&(s.text(l),s.addClass("black-text"),s.addClass("deep-orange"),s.addClass("lighten-5"),s.attr("data-tooltip","【Blast性能アップ】<br>"+o),gBlastCntTotal++))}),$(".map-table").fadeIn(1e3),$(".chara-status").fadeIn(1e3),$("#skill-area").fadeIn(1e3),$("#searchNodeTitle").fadeIn(1e3);var t="HP "+gHpCnt+" / "+gHpCntTotal+"<br>ATK "+gAtkCnt+" / "+gAtkCntTotal+"<br>DEF "+gDefCnt+" / "+gDefCntTotal+"<br>Ability "+gAbilityCnt+" / "+gAbilityCntTotal+"<br>Skill "+gSkillCnt+" / "+gSkillCntTotal+"<br>Accele "+gAcceleCnt+" / "+gAcceleCntTotal+"<br>Charge "+gChargeCnt+" / "+gChargeCntTotal+"<br>Blast "+gBlastCnt+" / "+gBlastCntTotal;$("#charaReleaseTd").attr("data-tooltip",t),setTimeout(function(){var t,a=["black","gray","blue","navy","teal","green","lime","yellow","red","fuchsia","olive","purple","maroon"],e=0,l=0,o=[],s=[];$.each(routeInfos,function(r,n){s=[],$.each(n,function(n,i){0!=i&&(l=i,null==gLineList[l-1]&&(t=new LeaderLine(document.getElementById("Node"+e),document.getElementById("Node"+l),{path:"straight",dash:!0,color:a[r],hide:!0}),gLineList[l-1]=t,s.push(t)),e=i),1==n&&-1==$.inArray(i,o)&&o.push(i)}),e=0,l=0,$.each(s,function(t,a){setTimeout(function(){a.show("fade")},50+80*t)})});var r="";$.each(o,function(t,a){""!=r&&(r+=", "),r=r+"#Node"+a,gNextNodeList.push(a),gLineList[a-1].dash=gDashEffect}),$(r).addClass("next-node"),gTimeout=setTimeout(function(){$(r).addClass(gNextNodeEffect)},1500),$(".tooltipped").tooltip(),$(".dropdown-trigger").dropdown(),$.unblockUI()},1500)})}),$(".map-area .btn-floating").click(function(t){var a=$(this);if(!a.hasClass("on")&&a.hasClass("next-node")){var e=parseInt($("#charaReleasePoint").text(),10);if(e!=parseInt($("#charaReleaseCap").text(),10)){$("#charaReleasePoint").hasClass("red-text")&&$("#charaReleasePoint").removeClass("red-text"),$("#charaReleasePoint").text(e+1),a.removeClass("next-node"),a.removeClass(gNextNodeEffect),clearTimeout(gTimeout),a.removeClass("lighten-5"),a.addClass("darken-1"),a.removeClass("black-text"),a.addClass("on");var l=[],o=parseInt(a.attr("id").slice(4),10);$.each(routeInfos,function(t,a){var e=$.inArray(o,a);-1!=e&&e+1!=a.length&&-1==$.inArray(a[e+1],l)&&(l.push(a[e+1]),gLineList[a[e+1]-1].dash=gDashEffect)});var s=gLineList[o-1];s.dash=!1,s.color="cyan",s.size=6,$.each(gNextNodeList,function(t,a){a!=o&&-1==$.inArray(a,l)&&l.push(a)}),gNextNodeList=l;var r="";$.each(gNextNodeList,function(t,a){0!=t&&(r+=", "),r=r+"#Node"+a});var n=nodeInfos[o],i=n[1],d=n[2];"HP"==i&&($("#charaHpTotal").removeClass("red-text"),$("#charaHpPlus").removeClass("red-text"),gHpCnt++),"ATK"==i&&($("#charaAtkTotal").removeClass("red-text"),$("#charaAtkPlus").removeClass("red-text"),gAtkCnt++),"DEF"==i&&($("#charaDefTotal").removeClass("red-text"),$("#charaDefPlus").removeClass("red-text"),gDefCnt++),"Ability"==i&&($("#dropdown3").append('<li><a href="javascript:void(0)" class="indigo-text">'+d+"</a></li>"),M.toast({html:a.attr("data-tooltip")}),gAbilityCnt++),"Skill"==i&&($("#dropdown3").append('<li><a href="javascript:void(0)" class="purple-text">'+d+"</a></li>"),M.toast({html:a.attr("data-tooltip")}),gSkillCnt++),"Accele"==i&&($("#dropdown3").append('<li><a href="javascript:void(0)" class="light-blue-text">Accele '+d+"</a></li>"),M.toast({html:a.attr("data-tooltip")}),gAcceleCnt++),"Charge"==i&&($("#dropdown3").append('<li><a href="javascript:void(0)" class="lime-text">Charge '+d+"</a></li>"),M.toast({html:a.attr("data-tooltip")}),gChargeCnt++),"Blast"==i&&($("#dropdown3").append('<li><a href="javascript:void(0)" class="deep-orange-text">Blast '+d+"</a></li>"),M.toast({html:a.attr("data-tooltip")}),gBlastCnt++);var c="HP "+gHpCnt+" / "+gHpCntTotal+"<br>ATK "+gAtkCnt+" / "+gAtkCntTotal+"<br>DEF "+gDefCnt+" / "+gDefCntTotal+"<br>Ability "+gAbilityCnt+" / "+gAbilityCntTotal+"<br>Skill "+gSkillCnt+" / "+gSkillCntTotal+"<br>Accele "+gAcceleCnt+" / "+gAcceleCntTotal+"<br>Charge "+gChargeCnt+" / "+gChargeCntTotal+"<br>Blast "+gBlastCnt+" / "+gBlastCntTotal;$("#charaReleaseTd").attr("data-tooltip",c),$("#charaReleaseTd.tooltipped").tooltip(),$(r).removeClass("next-node"),$(r).removeClass(gNextNodeEffect),$(r).addClass("next-node"),gTimeout=setTimeout(function(){$(r).addClass(gNextNodeEffect)},200)}else $("#charaReleasePoint").addClass("red-text")}}),$("#dropdown2 li").click(function(t){if($.blockUI({message:null,overlayCSS:{backgroundColor:"#fff",opacity:"0.0",cursor:"wait",zIndex:900}}),$("#dropdown2 li a i").hide(),$(".btn-floating").removeClass("pulse"),"soNone"==t.target.id)return $("#"+t.target.id+" i").show(),void $.unblockUI();var a="";if("soHp"!=t.target.id&&"soAtk"!=t.target.id&&"soDef"!=t.target.id&&"soSkill"!=t.target.id&&"soAbility"!=t.target.id||$.each(nodeInfos,function(e,l){var o="#Node"+l[0],s=l[1],r=($(o),"");"soHp"==t.target.id&&(r="HP"),"soAtk"==t.target.id&&(r="ATK"),"soDef"==t.target.id&&(r="DEF"),"soSkill"==t.target.id&&(r="Skill"),"soAbility"==t.target.id&&(r="Ability"),s==r&&(""!=a&&(a=", "+a),a=o+a)}),"soHpMaxNode"==t.target.id||"soAtkMaxNode"==t.target.id||"soDefMaxNode"==t.target.id){var e=0;$.each(nodeInfos,function(l,o){var s="#Node"+o[0],r=o[1],n=o[2],i=($(s),"");"soHpMaxNode"==t.target.id&&(i="HP"),"soAtkMaxNode"==t.target.id&&(i="ATK"),"soDefMaxNode"==t.target.id&&(i="DEF"),r==i&&(e<n?(a=s+(a=""),e=n):e==n&&(""!=a&&(a=", "+a),a=s+a))})}if("soHpMaxRoute"==t.target.id||"soAtkMaxRoute"==t.target.id||"soDefMaxRoute"==t.target.id){"soHpMaxRoute"==t.target.id&&(searchWord="HP"),"soAtkMaxRoute"==t.target.id&&(searchWord="ATK"),"soDefMaxRoute"==t.target.id&&(searchWord="DEF");var l=0,o=0;$.each(routeInfos,function(t,a){var e=0;$.each(a,function(t,a){var l=nodeInfos[a],o=l[1],s=l[2];o==searchWord&&(e+=s)}),o<e&&(l=t,o=e)});var s=routeInfos[l];$.each(s,function(t,e){0!=t&&(""!=a&&(a=", "+a),a="#Node"+e+a)})}"soDisc"==t.target.id&&$.each(nodeInfos,function(t,e){var l="#Node"+e[0],o=e[1];$(l);"Accele"!=o&&"Charge"!=o&&"Blast"!=o||(""!=a&&(a=", "+a),a=l+a)}),"soLastNode"==t.target.id&&$.each(routeInfos,function(t,e){var l="#Node"+e[e.length-1];""!=a&&(a=", "+a),a=l+a}),setTimeout(function(){$(a).addClass("pulse")},500),$("#"+t.target.id+" i").show(),$.unblockUI()}),$("#capCheck").click(function(t){var a=parseInt($("#charaReleasePoint").text(),10);this.checked?this.checked&&a>60?this.checked=!1:$("#charaReleaseCap").text("60"):($("#charaReleasePoint").hasClass("red-text")&&$("#charaReleasePoint").removeClass("red-text"),$("#charaReleaseCap").text("100"))}),gBakTotal="",gBakPlus="",$(".map-area .btn-floating").mouseover(function(){var t=$(this);if(!t.hasClass("on")&&t.hasClass("next-node")){var a=parseInt(t.attr("id").slice(4),10),e=nodeInfos[a],l=e[1],o=e[2];if("HP"==l){$("#charaHpTotal").addClass("red-text"),$("#charaHpPlus").addClass("red-text"),gBakTotal=$("#charaHpTotal").text(),gBakPlus=$("#charaHpPlus").text();var s=parseInt($("#charaHpTotal").text()),r=parseInt($("#charaHpPlus").text().slice(2).slice(0,-1));s+=parseInt(o),r+=parseInt(o),$("#charaHpTotal").text(s),$("#charaHpPlus").text("(+"+r+")")}if("ATK"==l){$("#charaAtkTotal").addClass("red-text"),$("#charaAtkPlus").addClass("red-text"),gBakTotal=$("#charaAtkTotal").text(),gBakPlus=$("#charaAtkPlus").text();var n=parseInt($("#charaAtkTotal").text()),i=parseInt($("#charaAtkPlus").text().slice(2).slice(0,-1));n+=parseInt(o),i+=parseInt(o),$("#charaAtkTotal").text(n),$("#charaAtkPlus").text("(+"+i+")")}if("DEF"==l){$("#charaDefTotal").addClass("red-text"),$("#charaDefPlus").addClass("red-text"),gBakTotal=$("#charaDefTotal").text(),gBakPlus=$("#charaDefPlus").text();var d=parseInt($("#charaDefTotal").text()),c=parseInt($("#charaDefPlus").text().slice(2).slice(0,-1));d+=parseInt(o),c+=parseInt(o),$("#charaDefTotal").text(d),$("#charaDefPlus").text("(+"+c+")")}}}).mouseout(function(){var t=$(this);if(!t.hasClass("on")&&t.hasClass("next-node")){var a=parseInt(t.attr("id").slice(4),10),e=nodeInfos[a],l=e[1];e[2];"HP"==l&&($("#charaHpTotal").removeClass("red-text"),$("#charaHpPlus").removeClass("red-text"),$("#charaHpTotal").text(gBakTotal),$("#charaHpPlus").text(gBakPlus)),"ATK"==l&&($("#charaAtkTotal").removeClass("red-text"),$("#charaAtkPlus").removeClass("red-text"),$("#charaAtkTotal").text(gBakTotal),$("#charaAtkPlus").text(gBakPlus)),"DEF"==l&&($("#charaDefTotal").removeClass("red-text"),$("#charaDefPlus").removeClass("red-text"),$("#charaDefTotal").text(gBakTotal),$("#charaDefPlus").text(gBakPlus))}});