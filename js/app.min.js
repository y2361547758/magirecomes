...
[5,1],[5,3],[5,1],[5,3],[6,1],[5,3],[5,2],[6,2],[5,1],[6,2],[5,1],[5,2],[5,1],[5,1],[5,2],[5,2],[5,3],[5,2],[5,1],[5,3],[5,1],[5,2],[5,2],[6,3],[5,3],[5,2],[6,1],[5,2],[5,3],[6,2],[5,1],[6,2]]},ABILITY_LIST={a0:"\u3010\u30af\u30a8\u30b9\u30c8\u306e\u307f\u3011\u30b5\u30f4\u30a1\u30a4\u30d6[\u2160]",a1:"\u3010\u30af\u30a8\u30b9\u30c8\u306e\u307f\u3011\u8010\u3048\u308b",a2:"Accele MPUP[\u2162]",a3:"Accele MPUP[\u2167]",a4:"Blast \u30c0\u30e1\u30fc\u30b8UP[\u2161]",a5:"Blast \u30c0\u30e1\u30fc\u30b8UP[\u2162]",
...
c5:"\u653b\u6483\u6642\u306b\u78ba\u7387\u3067\u9b45\u4e86(1T)\u3092\u4ed8\u4e0e[\u2161]",c6:"MP\u7372\u5f97\u91cfUP[\u2161]",c7:"\u6575\u72b6\u614b\u7570\u5e38\u6642\u30c0\u30e1\u30fc\u30b8UP[\u2161]",c8:"\u78ba\u7387\u3067\u6311\u767a\u7121\u8996[\u2166]",c9:"\u78ba\u7387\u3067\u30b9\u30ad\u30eb\u30af\u30a4\u30c3\u30af[\u2161]",ca:"\u30c1\u30e3\u30fc\u30e0\u7121\u52b9"},FLAG_TYPE={1:"\u5acc\u60aa",2:"\u60b2\u5606",3:"\u6fc0\u6012",4:"\u6050\u6016",5:"\u9a5a\u5606",6:"\u671f\u5f85",7:"\u604d\u60da",
...
""),gAtkCntTotal++):"DEF"==h?(g.html("DEF<br>+"+getDefValue(d)).addClass("statusup").addClass("black-text").addClass("blue").addClass("lighten-5").attr("data-tooltip",""),gDefCntTotal++):"Ability"==h?(a=ABILITY_LIST[a[2]],g.text("Ability").addClass("black-text").addClass("indigo").addClass("lighten-5").addClass("tooltipped").attr("data-tooltip","\u3010\u6f5c\u5728\u30a2\u30d3\u30ea\u30c6\u30a3\u3011<br>"+a),gAbilityCntTotal++):"Skill"==h?(a=a[2],g.text("Skill").addClass("black-text").addClass("purple").addClass("lighten-5").addClass("tooltipped").attr("data-tooltip",
"\u3010\u6f5c\u5728\u30b9\u30ad\u30eb\u3011<br>"+a),gSkillCntTotal++):"Accele"==h?(g.text("Accele").addClass("black-text").addClass("light-blue").addClass("lighten-5").addClass("tooltipped").attr("data-tooltip","\u3010Accele\u6027\u80fd\u30a2\u30c3\u30d7\u3011<br>+"+gAccele+"%"),gAcceleCntTotal++):"Charge"==h?(g.text("Charge").addClass("black-text").addClass("lime").addClass("lighten-5").addClass("tooltipped").attr("data-tooltip","\u3010Charge\u6027\u80fd\u30a2\u30c3\u30d7\u3011<br>+"+gCharge+"%"),
gChargeCntTotal++):"Blast"==h&&(g.text("Blast").addClass("black-text").addClass("deep-orange").addClass("lighten-5").addClass("tooltipped").attr("data-tooltip","\u3010Blast\u6027\u80fd\u30a2\u30c3\u30d7\u3011<br>+"+gBlast+"%"),gBlastCntTotal++)}$("#mapTable > tbody > tr > td > div >div > a.tooltipped").tooltip();b="HP "+gHpCnt+" / "+gHpCntTotal+"<br>ATK "+gAtkCnt+" / "+gAtkCntTotal+"<br>DEF "+gDefCnt+" / "+gDefCntTotal+"<br>Ability "+gAbilityCnt+" / "+gAbilityCntTotal+"<br>Skill "+gSkillCnt+" / "+
gSkillCntTotal+"<br>Accele "+gAcceleCnt+" / "+gAcceleCntTotal+"<br>Charge "+gChargeCnt+" / "+gChargeCntTotal+"<br>Blast "+gBlastCnt+" / "+gBlastCntTotal;$("#charaReleaseTd").attr("data-tooltip",b);$("#charaReleaseTd").tooltip();$("#mapTable").fadeIn(800);$("#statusCard").fadeIn(800);$("#btnStatusShow").fadeIn(800);$("#btnStatusCardShow").fadeIn(800);$("#btnMaterialCardShow").fadeIn(800);$("#btnMaterialMove").fadeIn(800);$("#materialCard").fadeIn(800);$("#btnASShow").fadeIn(800);$("#btnTreeMode").fadeIn(800);
$("#btnLockMode").fadeIn(800);$("#btnShowOption").fadeIn(800);$("#btnAllReset").fadeIn(800);$("#searchNodeTitle").fadeIn(800,function(){for(var b=0,a=0,c=[],d=[],f=gRouteInfos.length,e=0;e<f;e++){for(var g=gRouteInfos[e],h=g.length,p=0;p<h;p++){var k=g[p];0!=k&&(a=k,void 0==gLineList[a-1]&&(b=new LeaderLine(document.getElementById("Node"+b),document.getElementById("Node"+a),{path:"straight",dash:!0,color:COLOR_PATTERN[e],hide:!0}),gLineList[a-1]=b,d.push(b)),b=k);1==p&&-1==$.inArray(k,c)&&c.push(k)}a=
b=0;$.each(d,function(b,a){setTimeout(function(){a.show("fade")},800+80*b)});d=[]}var t="";a=c.length;for(e=0;e<a;e++)d=c[e],""!=t&&(t+=", "),t=t+"#Node"+d,gNextNodeList.push(d),gLineList[d-1].dash=gDashEffect;$(t).addClass("next-node");gTimeout=setTimeout(function(){$(t).addClass(gNextNodeEffect)},1500);$.unblockUI()})})},getHpValue=function(a){a=gNodeInfos[a];var b=a[2];return void 0!=b?b:gHpList[a[0]-1]},getAtkValue=function(a){a=gNodeInfos[a];var b=a[2];return void 0!=b?b:gAtkList[a[0]-1]},getDefValue=
function(a){a=gNodeInfos[a];var b=a[2];return void 0!=b?b:gDefList[a[0]-1]};
