...
2],[5,3],[5,1],[6,3],[6,3],[5,3],[5,2],[6,2],[5,2],[5,1],[5,3],[6,2],[6,3],[6,1],[5,3],[5,3],[6,2]]};gRouteInfos=gNodeInfos=null;gPcFlg=!0;gNextNodeEffect="next-effect";gDashEffect={animation:!0};gAttribute="";gBlast=gCharge=gAccele=gLv2SozaiNm=0;gKeno=[];gHitan=[];gGekido=[];gKyofu=[];gKyotan=[];gKitai=[];gKokotsu=[];gKeiai=[];gHpList=[];gAtkList=[];gDefList=[];
